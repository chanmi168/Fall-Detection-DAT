...
training_params_file='training_params_list_λ1_3.json'

inputdir='../../data_mic/stage1/preprocessed_18hz_5fold'
outputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_UMAFall_cross-config_loss_earlystop_λ1_3'
mkdir -p $outputdir

echo '=================================running stage 2 [early stop at lowest total loss, lambda=1.3]================================='
