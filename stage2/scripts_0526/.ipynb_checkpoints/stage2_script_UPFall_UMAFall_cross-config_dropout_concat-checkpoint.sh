...
outputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_UMAFall_cross-config_dropout0_5_concat'
mkdir -p $outputdir

echo '=================================running stage 2 [dropout 0.5, lambda 1, dropout after concat]================================='
