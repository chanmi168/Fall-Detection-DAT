...
inputdir='../../data_mic/stage1/preprocessed_WithoutNormal_18hz_5fold_aug'
outputdir='../../data_mic/stage2/modeloutput_WithoutNormal_18hz_5fold_aug_UPFall_UMAFall_cross-config_diffCV'
mkdir -p $outputdir
