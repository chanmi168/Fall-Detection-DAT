...
outputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_UMAFall_cross-config_diffCV_earlystop_F1fixed'
mkdir -p $outputdir

echo '=================================running stage 2 [early stopping, F1 fixed, dropout]================================='
