...
echo '=================================running UMAFall_UPFall_cross_config [early stop at reversed val F1, 5 epochs] allHP================================='

inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_UMAFall_cross-config_reversed_earlystop_repeat'
outputdir='../../data_mic/stage3/UMAFall_UPFall_cross_config_reversed_earlystop_repeat'
mkdir -p $outputdir
...
--debug_F1 $debug_F1 \
--tasks_list 'UMAFall_wrist-UPFall_wrist UMAFall_ankle-UPFall_ankle' \
