...
inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UMAFall_cross-pos_loss_earlystop_revision'

# inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UMAFall_cross-pos_loss_earlystop'
outputdir='../../data_mic/stage3/UMAFall_cross-pos_loss_earlystop_revision'
mkdir -p $outputdir
...
| tee $outputdir/stage3_UMAFall_logs.txt
