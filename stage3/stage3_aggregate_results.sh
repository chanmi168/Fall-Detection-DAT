...
echo '=================================running UPFall_UMAFall_cross_config_fixed================================='

inputdir='../../data_mic/stage2/modeloutput_WithoutNormal_18hz_5fold_UPFall_UMAFall_cross-config_fixed'
outputdir='../../data_mic/stage3/UPFall_UMAFall_cross_config_fixed'
mkdir -p $outputdir
...
outputdir='../../data_mic/stage3/UMAFall_UPFall_cross_config_fixed'
mkdir -p $outputdir
...
echo '=================================running UPFall_cross_pos_fixed================================='

inputdir='../../data_mic/stage2/modeloutput_WithoutNormal_18hz_5fold_UPFall_pos_fixed'
outputdir='../../data_mic/stage3/UPFall_cross_pos_fixed'
mkdir -p $outputdir
...
echo '=================================running UMAFall_cross_pos_fixed================================='
inputdir='../../data_mic/stage2/modeloutput_WithoutNormal_18hz_5fold_UMAFall_pos_fixed'
outputdir='../../data_mic/stage3/UMAFall_cross_pos_fixed'
mkdir -p $outputdir
...
echo '=================================running UPFall_FARSEEING_cross_config_fixed================================='

inputdir='../../data_mic/stage2/modeloutput_NormalforAllAxes_18hz_5fold_UPFall_FARSEEING_cross-config'
outputdir='../../data_mic/stage3/UPFall_FARSEEING_cross_config_norm'
mkdir -p $outputdir

python stage3_model_eval.py \
--input_folder $inputdir \
--output_folder $outputdir \
--tasks_list 'UPFall_rightpocket-FARSEEING_thigh UPFall_belt-FARSEEING_lowback' \
--src_names 'UPFall_rightpocket UPFall_belt' \
--tgt_names 'FARSEEING_thigh FARSEEING_lowback' \
| tee $outputdir/stage3_logs.txt

echo '=================================running UMAFall_FARSEEING_cross_config_fixed================================='

inputdir='../../data_mic/stage2/modeloutput_NormalforAllAxes_18hz_5fold_UMAFall_FARSEEING_cross-config'
outputdir='../../data_mic/stage3/UMAFall_FARSEEING_cross_config_norm'
mkdir -p $outputdir

python stage3_model_eval.py \
--input_folder $inputdir \
--output_folder $outputdir \
--tasks_list 'UMAFall_leg-FARSEEING_thigh UMAFall_waist-FARSEEING_lowback' \
--src_names 'UMAFall_leg UMAFall_waist' \
--tgt_names 'FARSEEING_thigh FARSEEING_lowback' \
| tee $outputdir/stage3_logs.txt
