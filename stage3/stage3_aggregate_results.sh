...
# outputdir='../../data_mic/stage3/UMAFall_cross_pos'
# mkdir -p $outputdir

# python stage3_model_eval.py \
# --input_folder 'stage2_modeloutput_18hz_5fold' \
# --output_folder $outputdir \
...
# --src_names 'UMAFall_wrist UMAFall_waist UMAFall_ankle UMAFall_chest' \
# --tgt_names 'UMAFall_wrist UMAFall_waist UMAFall_ankle UMAFall_chest' \
# | tee $outputdir/stage3_logs.txt


# outputdir='../../data_mic/stage3/UPFall_cross_pos'
# mkdir -p $outputdir
