...
echo '=================================running UMAFall_UPFall_cross_config [resample, deeper] allHP================================='

inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_UMAFall_cross-config_diffCV_deeper'
outputdir='../../data_mic/stage3/UMAFall_UPFall_cross_config_diffCV_resample_deeper'
mkdir -p $outputdir
