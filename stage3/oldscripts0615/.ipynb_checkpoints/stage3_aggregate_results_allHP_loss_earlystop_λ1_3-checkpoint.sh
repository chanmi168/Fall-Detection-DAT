...
echo '=================================running UMAFall_UPFall_cross_config [earlystop at lowest total loss] allHP================================='

inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_UMAFall_cross-config_loss_earlystop_λ1_3'
outputdir='../../data_mic/stage3/UMAFall_UPFall_cross_config_loss_earlystop_λ1_3'
mkdir -p $outputdir
