...
inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_UMAFall_cross-config_loss_earlystop'
outputdir='../../data_mic/stage3/UMAFall_UPFall_cross_config_loss_earlystop'
mkdir -p $outputdir
