...
echo '=================================running UMAFall_UPFall_cross_config [early stop at reversed val F1, 1 epoch] allHP================================='

inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_UMAFall_cross-config_reversed_earlystop'
outputdir='../../data_mic/stage3/UMAFall_UPFall_cross_config_reversed_earlystop'
mkdir -p $outputdir
