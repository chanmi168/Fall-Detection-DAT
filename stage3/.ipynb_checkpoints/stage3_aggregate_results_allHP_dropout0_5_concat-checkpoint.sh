...
echo '=================================running UMAFall_UPFall_cross_config [dropout after concat] allHP================================='


inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_UMAFall_cross-config_dropout0_5_concat'
outputdir='../../data_mic/stage3/UMAFall_UPFall_cross_config_diffCV_resample_dropout0_5_concat'
mkdir -p $outputdir
