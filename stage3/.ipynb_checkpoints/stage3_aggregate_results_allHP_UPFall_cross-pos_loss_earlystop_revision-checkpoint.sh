...
inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_cross-pos_loss_earlystop_revision'
outputdir='../../data_mic/stage3/UPFall_cross-pos_loss_earlystop_revision'
mkdir -p $outputdir
