...
echo '=================================running UPFall_cross_pos [earlystop at lowest total loss, HP search] allHP================================='

inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_cross-pos_loss_earlystop_HPsearch'
outputdir='../../data_mic/stage3/UPFall_cross-pos_loss_earlystop_HPsearch'
mkdir -p $outputdir
