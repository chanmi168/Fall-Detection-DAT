...
inputdir='../../data_mic/stage2/modeloutput_18hz_5fold_UPFall_UMAFall_cross-config_dropout'
outputdir='../../data_mic/stage3/UMAFall_UPFall_cross_config_diffCV_resample_dropout'
mkdir -p $outputdir
